...
<body>
    <div>
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white [background:radial-gradient(125%_125%_at_50%_10%,#5d639375_40%,#050f64_100%)]  text-black">

            <!-- Header -->
            <div class="fixed bg-gradient-to-r from-slate-900 to-slate-50 w-full flex items-center justify-between h-14 text-white px-4 z-10">
                <a href="">

                    <x-application-logo class="block h-9 w-auto fill-current text-white" />
                </a>
                <div class="flex justify-end items-center h-14 bg-gradient-to-r from-slate-900 to-slate-50 header-right">

                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-semibold rounded-md text-white bg-gradient-to-r from-slate-500 to-slate-800 hover:text-gray-400 focus:outline-none transition ease-in-out duration-150">
            ...
            <!-- Sidebar -->
            <div
                class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-gradient-to-r from-slate-900 to-slate-700 h-full text-white transition-all duration-300 border-none z-10 sidebar">
                <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                    <ul class="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('dashboard') }}"
                                class="relative flex flex-row items-center h-11 focus:outline-none  hover:bg-gradient-to-tl from-blue-200 via-gray-800 to-blue-900  text-white  border-l-4 border-transparent hover:border-white pr-6 ">
                    ...
                    <p class="mb-14 px-5 py-3 hidden md:block text-center text-xs">Copyright NAK @2024</p>
                </div>
            </div>
            <!-- ./Sidebar -->
